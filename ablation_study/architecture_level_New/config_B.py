# config_B.py
# Configuration B: Bidirectional + Gaussian
# 
# Purpose: Tests the effect of bidirectionality alone
# Compares to Config A to isolate the bidirectional contribution
#
# Architecture:
...
#
# What it isolates:
#   - Effect of bidirectional context (vs Config A: causal-only)
#   - Same UQ head (Gaussian), same CNN, same pooling
...
CFG = dict(
    ...
    # CONFIG B: Bidirectional + Gaussian
    bidirectional = True,    # ← BIDIRECTIONAL (forward + backward)
...
def train_soh(model, train_ds, val_ds, cfg):
    print("\n" + "=" * 60)
    print(f"  TRAINING CONFIG B: Bidirectional + Gaussian")
    print("=" * 60)
...
def evaluate_soh(model, val_loader, test_loader, cfg):
    print("\n" + "=" * 60)
    print("  SOH EVALUATION - TEST SET (Config B: Bidirectional + Gaussian)")
    print("=" * 60)
...
def print_deployment_report(model, cfg):
    print("\n" + "=" * 60)
    print("  MODEL COMPLEXITY & DEPLOYMENT METRICS (Config B)")
    print("=" * 60)
...
if __name__ == "__main__":
    print("=" * 60)
    print("  CONFIGURATION B: Bidirectional + Gaussian")
    print("=" * 60)
    print(f"Device: {DEVICE}")
    ...
    print("\nBuilding BEM-SOH model (Config B: Bidirectional + Gaussian)...")
