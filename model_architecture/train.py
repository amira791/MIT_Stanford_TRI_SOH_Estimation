...
--------------------------
Three-block design:
  Block 1 — 1-D CNN Encoder (local temporal patterns)
  Block 2 — Mamba State Space Model (long-range degradation)
  Block 3 — MC Dropout UQ Head (uncertainty quantification)
"""
