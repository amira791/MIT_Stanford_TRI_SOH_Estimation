# train_ncm.py
# Train BEM-SOH from scratch on SNL NCM dataset
# Purpose: Test architecture generalization to NCM chemistry
# 
# Key differences from MIT training:
#   - input_dim = 8 (not 10)
#   - Uses NCM_FEAT_COLS (no DCIR, temp, IR)
...
# ─── NCM-SPECIFIC FEATURES (8 features, no DCIR/temp/IR) ───
NCM_FEAT_COLS = [
    "charge_capacity",
    "charge_energy",
...
CFG = dict(
    ...
    # Evidential-specific (same as MIT)
...
class NCMSequenceDataset(Dataset):
    """Sliding-window dataset for NCM data."""
...
def evaluate_soh(model, val_loader, test_loader, cfg):
    print("\n" + "=" * 60)
    print("  SOH EVALUATION - NCM TEST SET")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print(f"Device: {DEVICE}")
    print(f"Input features: {CFG['input_dim']} (NCM-specific)")
    ...
    # ─── Build model ───
    print("\nBuilding BEM-SOH model for NCM...")
    ...
    print("\n" + "=" * 60)
    print("  FINAL RESULTS SUMMARY - NCM")
    print("=" * 60)
